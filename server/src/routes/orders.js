...
router.post('/:id/shop-deliver', authenticate, authorize('shop', 'admin'), orders.shopDeliverOrder);
router.post('/:id/verify-pickup', authenticate, authorize('student', 'admin', 'shop'), orders.verifyPickupByStudent);
